...
async function filterGraph(pkgGraph, packageSelectors, opts) {
    ...
    for (const selector of packageSelectors) {
        ...
        if (selector.diff) {
            entryPackages = await getChangedPackages_1.default(Object.keys(pkgGraph), selector.diff, { workspaceDir: (_a = selector.parentDir, (_a !== null && _a !== void 0 ? _a : opts.workspaceDir)) });
        }
