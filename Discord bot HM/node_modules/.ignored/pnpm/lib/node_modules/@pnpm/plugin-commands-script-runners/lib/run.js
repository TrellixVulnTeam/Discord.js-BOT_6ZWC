...
exports.completion = async (args, cliOpts) => {
    ...
    const manifest = await cli_utils_1.readProjectManifestOnly((_a = cliOpts.dir, (_a !== null && _a !== void 0 ? _a : process.cwd())), cliOpts);
    return Object.keys((_b = manifest.scripts, (_b !== null && _b !== void 0 ? _b : {}))).map((name) => ({ name }));
};
