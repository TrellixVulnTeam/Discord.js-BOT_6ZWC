...
async function handler(input, opts) {
    ...
    const updateMatch = opts.update && patternedInput.length ? matcher_1.default(patternedInput) : null;
    if (updateMatch) {
        input = [
            ...unpatternedInput,
            ...recursive_1.matchDependencies(updateMatch, manifest, includeDirect),
        ];
    }
