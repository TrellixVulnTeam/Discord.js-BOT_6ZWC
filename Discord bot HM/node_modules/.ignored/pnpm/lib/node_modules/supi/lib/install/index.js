...
async function mutateModules(projects, maybeOpts) {
    ...
    async function _install() {
        ...
        async function installCase(project) {
            ...
            const scripts = opts.ignoreScripts ? {} : (_c = (_b = project.manifest) === null || _b === void 0 ? void 0 : _b.scripts, (_c !== null && _c !== void 0 ? _c : {}));
    ...
    for (const depField of types_1.DEPENDENCIES_FIELDS) {
        ...
        for (const depName of depNames) {
            ...
            const dir = isLinked
                ...
                : (_c = (_b = (_a = workspacePackages) === null || _a === void 0 ? void 0 : _a[depName]) === null || _b === void 0 ? void 0 : _b[importerDeps[depName]]) === null || _c === void 0 ? void 0 : _c.dir;
            if (!dir)
                continue;
...
async function installInContext(projects, ctx, opts) {
    ...
    const preferredVersions = (_a = opts.preferredVersions, (_a !== null && _a !== void 0 ? _a : (!opts.update &&
...
async function toResolveImporter(opts, project) {
    ...
    return {
        ...project,
        preferredVersions: (_b = (_a = opts.preferredVersions, (_a !== null && _a !== void 0 ? _a : (project.manifest && getPreferredVersions_1.default(project.manifest)))), (_b !== null && _b !== void 0 ? _b : {})),
