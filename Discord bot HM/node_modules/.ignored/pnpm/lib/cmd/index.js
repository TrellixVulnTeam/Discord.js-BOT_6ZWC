...
for (let i = 0; i < commands.length; i++) {
    const { cliOptionsTypes, commandNames, completion, handler, help, rcOptionsTypes, } = commands[i];
...
handlerByCommandName.completion = completion_1.default({
    ...
    globalOptionTypes: exports.GLOBAL_OPTIONS,
    initialCompletion,
});
...
function getCliOptionsTypes(commandName) {
    var _a, _b;
    return ((_b = (_a = cliOptionsTypesByCommandName)[commandName]) === null || _b === void 0 ? void 0 : _b.call(_a)) || {};
}
exports.getCliOptionsTypes = getCliOptionsTypes;
function getRCOptionsTypes(commandName) {
    var _a, _b;
    return (commandName && ((_b = (_a = rcOptionsTypesByCommandName)[commandName]) === null || _b === void 0 ? void 0 : _b.call(_a))) || {};
}
