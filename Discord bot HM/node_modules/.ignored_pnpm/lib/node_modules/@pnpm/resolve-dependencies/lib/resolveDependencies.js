    ...
    const pkgAddresses = (await Promise.all(extendedWantedDeps
        ...
        const resolveChildren = async function (preferredVersions) {
            ...
            const children = await resolveDependencies(ctx, getWantedDependencies(resolveDependencyResult.pkg, {
                ...
                parentDependsOnPeers: Boolean(Object.keys((_e = (_d = (_c = resolveDependencyOpts.dependencyLockfile) === null || _c === void 0 ? void 0 : _c.peerDependencies, (_d !== null && _d !== void 0 ? _d : resolveDependencyResult.pkg.peerDependencies)), (_e !== null && _e !== void 0 ? _e : {}))).length),
...
function getDepsToResolve(wantedDependencies, wantedLockfile, options) {
    var _a, _b, _c, _d;
    const resolvedDependencies = (_a = options.resolvedDependencies, (_a !== null && _a !== void 0 ? _a : {}));
    const preferredDependencies = (_b = options.preferredDependencies, (_b !== null && _b !== void 0 ? _b : {}));
    ...
    for (const wantedDependency of wantedDependencies) {
        ...
        if (!proceedAll && ((_d = (_c = infoFromLockfile) === null || _c === void 0 ? void 0 : _c.dependencyLockfile) === null || _d === void 0 ? void 0 : _d.peerDependencies)) {
            proceed = true;
...
function getWantedDependencies(pkg, opts) {
    ...
    if (!deps.length && opts.resolvedDependencies && opts.useManifestInfoFromLockfile) {
        const optionalDependencyNames = (_a = opts.optionalDependencyNames, (_a !== null && _a !== void 0 ? _a : []));
